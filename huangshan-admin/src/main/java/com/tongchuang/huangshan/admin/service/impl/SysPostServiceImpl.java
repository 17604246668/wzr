...
import com.tongchuang.huangshan.admin.mapper.SysPostMapper;
import com.tongchuang.huangshan.admin.mapper.SysUserPostMapper;
...
public class SysPostServiceImpl implements ISysPostService
{
    ...
    public int deletePostByIds(String[] postIds)
    {
        for (String postId : postIds)
        {
            ...
            {
                throw new HuangshanException(ResultEnum.POST_IS_USE.getCode(),String.format("%1$s已分配,不能删除", post.getPostName()));
            }
        }
