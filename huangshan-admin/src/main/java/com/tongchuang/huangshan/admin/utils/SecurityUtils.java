package com.tongchuang.huangshan.admin.utils;
...
public class SecurityUtils
{
    ...
    public static String getUsername()
    {
        ...
        {
            throw new HuangshanException(ResultEnum.USER_ACCOUNT_IS_ERROR);
        }
    }
    ...
    public static LoginUser getLoginUser()
    {
        ...
        {
            throw new HuangshanException(ResultEnum.USER_INFO_IS_ERROR);
        }
    }
