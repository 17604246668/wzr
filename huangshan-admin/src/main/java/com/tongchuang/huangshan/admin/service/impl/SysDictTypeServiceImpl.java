...
import com.tongchuang.huangshan.admin.mapper.SysDictDataMapper;
import com.tongchuang.huangshan.admin.mapper.SysDictTypeMapper;
import com.tongchuang.huangshan.admin.service.ISysDictTypeService;
import com.tongchuang.huangshan.admin.utils.DictUtils;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService
{
    ...
    public int deleteDictTypeByIds(Long[] dictIds)
    {
        for (Long dictId : dictIds)
        {
            ...
            {
                throw new HuangshanException(ResultEnum.DICT_TYPE_IS_USE.getCode(),String.format("%1$s已分配,不能删除", dictType.getDictName()));
            }
        }
