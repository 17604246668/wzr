package com.tongchuang.huangshan.admin.aspect;
...
import com.tongchuang.huangshan.model.dtos.admin.base.BaseEntity;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.tongchuang.huangshan.admin.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StrFormatterUtil.format(" OR {}.dept_id = {} ", deptAlias, user.getDeptId()));
            }
            ...
            else if (DATA_SCOPE_SELF.equals(dataScope))
            {
                ...
                {
                    sqlString.append(StrFormatterUtil.format(" OR {}.user_id = {} ", userAlias, user.getUserId()));
                }
                else
                {
